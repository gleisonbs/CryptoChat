#############################################################################
# Makefile for building: CryptoChat
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  CryptoChat.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile CryptoChat.pro
#############################################################################
...
CXXFLAGS      = -std=c++11 -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong --param=ssp-buffer-size=4 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = CryptoChat1.0.0
DISTDIR = /home/cafeina/workspace/CryptoChat/.tmp/CryptoChat1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro
LIBS          = $(SUBLIBS) -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread -lcrypto
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = crypto.cpp \
		main.cpp \
		UI/cryptochat_ui.cpp moc_cryptochat_ui.cpp
OBJECTS       = crypto.o \
		main.o \
		cryptochat_ui.o \
		moc_cryptochat_ui.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		CryptoChat.pro crypto.hpp \
		UI/cryptochat_ui.hpp crypto.cpp \
		main.cpp \
		UI/cryptochat_ui.cpp
QMAKE_TARGET  = CryptoChat
...
Makefile: CryptoChat.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile CryptoChat.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents crypto.hpp UI/cryptochat_ui.hpp $(DISTDIR)/
	$(COPY_FILE) --parents crypto.cpp main.cpp UI/cryptochat_ui.cpp $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_cryptochat_ui.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_cryptochat_ui.cpp
moc_cryptochat_ui.cpp: crypto.hpp \
		UI/cryptochat_ui.hpp
	/usr/lib/qt/bin/moc $(DEFINES) -I/usr/lib/qt/mkspecs/linux-g++ -I/home/cafeina/workspace/CryptoChat -I/home/cafeina/workspace/CryptoChat -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/5.2.0 -I/usr/include/c++/5.2.0/x86_64-unknown-linux-gnu -I/usr/include/c++/5.2.0/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/5.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/5.2.0/include-fixed -I/usr/include UI/cryptochat_ui.hpp -o moc_cryptochat_ui.cpp
...
main.o: main.cpp UI/cryptochat_ui.hpp \
		crypto.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

cryptochat_ui.o: UI/cryptochat_ui.cpp UI/cryptochat_ui.hpp \
		crypto.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cryptochat_ui.o UI/cryptochat_ui.cpp

moc_cryptochat_ui.o: moc_cryptochat_ui.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_cryptochat_ui.o moc_cryptochat_ui.cpp
